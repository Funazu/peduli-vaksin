        ...
        <div class="col-5">
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="/dashboard/masyarakat/create" method="POST">
                        @csrf
                        <div class="form-group mb-2">
                            <strong>NIK</strong>    
                            <input type="number" name="nik" placeholder="XXXXXXXX" class="form-control">
                        </div>
                        <div class="form-group mb-2">
                            <strong>Nama</strong>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="number" name="no_telp" placeholder="XXXXXXX" class="form-control">
                        </div>
                        <hr>
                        <div class="form-group mb-2">
